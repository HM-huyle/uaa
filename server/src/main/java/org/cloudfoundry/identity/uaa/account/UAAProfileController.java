...
@Controller
public class UAAProfileController {

    protected static Logger logger = LoggerFactory.getLogger(UAAProfileController.class);
    ...
    public UAAProfileController(final ApprovalStore approvalsService,
