...
import org.cloudfoundry.identity.uaa.account.UAAProfileController;
...
@WebAppConfiguration
@ContextConfiguration(classes = UAAProfileControllerMockMvcTests.ContextConfiguration.class)
class UAAProfileControllerMockMvcTests {
    ...
    static class ContextConfiguration extends WebMvcConfigurerAdapter {
        ...
        @Bean
        UAAProfileController profileController(ApprovalStore approvalsService,
                                            MultitenantClientServices clientDetailsService,
                                            SecurityContextAccessor securityContextAccessor,
                                            IdentityZoneManager identityZoneManager) {
            return new UAAProfileController(approvalsService, clientDetailsService, securityContextAccessor, identityZoneManager);
        }
    }
